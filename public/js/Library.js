...
document.querySelectorAll('.songItemPlay').forEach((btn, index) => {
  btn.addEventListener('click', function() {
    ...
    const audio = new Audio(window.songs[index].filePath);
    window.currentAudio = audio;
    
    // Обновляем информацию о текущей песне
    document.getElementById('masterSongName').textContent = window.songs[index].songName;
